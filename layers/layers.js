...
var format_RutasGranEscala_2 = new ol.format.GeoJSON();
var features_RutasGranEscala_2 = format_RutasGranEscala_2.readFeatures(json_RutasGranEscala_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RutasGranEscala_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RutasGranEscala_2.addFeatures(features_RutasGranEscala_2);
var lyr_RutasGranEscala_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RutasGranEscala_2, 
                style: style_RutasGranEscala_2,
                popuplayertitle: "Rutas Gran Escala %",
                interactive: true,
    title: 'Rutas Gran Escala %<br />\
    <img src="styles/legend/RutasGranEscala_2_0.png" /> 0 - 25<br />\
    <img src="styles/legend/RutasGranEscala_2_1.png" /> 25 - 50<br />\
    <img src="styles/legend/RutasGranEscala_2_2.png" /> 50 - 100<br />'
        });
...
var group_CostaRica = new ol.layer.Group({
                                layers: [lyr_Distritos_1,lyr_RutasGranEscala_2,lyr_PequeaEscala_3,],
                                fold: "open",
                                title: "Costa Rica"});

lyr_OSMStandard_0.setVisible(true);lyr_Distritos_1.setVisible(true);lyr_RutasGranEscala_2.setVisible(true);lyr_PequeaEscala_3.setVisible(true);
...
lyr_RutasGranEscala_2.set('fieldAliases', {'Equipment': 'Id Tramo', 'begin': 'begin', 'end': 'end', 'Tramos_Cap': 'Capacidad de Integración (KW)', 'Tramos_C_1': 'Capacidad Normalizada (%)', 'Tramos_Capacidad_Minima %_IC Max (kW)': 'Capacidad de Integración (KW)', 'Tramos_Capacidad_Minima %_Capacidad Normalizada (%)': 'Capacidad Normalizada (%)', });
lyr_PequeaEscala_3.set('fieldAliases', {'Transforma': 'Id Tranformador', 'Suma_Capac': 'Suma_Capac', 'Capacidad_': 'Capacidad de Integración (KW)', 'Capacida_1': 'Capacida_1', 'Criterio q': 'Criterio q', 'Cap Nom (k': 'Cap Nom (k', 'Coord. X': 'Coord. X', 'Coord. Y': 'Coord. Y', 'Capacidad': 'Capacidad Libre (%)', });
...
lyr_RutasGranEscala_2.set('fieldImages', {'Equipment': 'TextEdit', 'begin': 'Range', 'end': 'Range', 'Tramos_Cap': 'TextEdit', 'Tramos_C_1': 'TextEdit', 'Tramos_Capacidad_Minima %_IC Max (kW)': 'TextEdit', 'Tramos_Capacidad_Minima %_Capacidad Normalizada (%)': 'TextEdit', });
...
lyr_RutasGranEscala_2.set('fieldLabels', {'Equipment': 'inline label - always visible', 'begin': 'hidden field', 'end': 'hidden field', 'Tramos_Cap': 'header label - always visible', 'Tramos_C_1': 'hidden field', 'Tramos_Capacidad_Minima %_IC Max (kW)': 'hidden field', 'Tramos_Capacidad_Minima %_Capacidad Normalizada (%)': 'hidden field', });
lyr_PequeaEscala_3.set('fieldLabels', {'Transforma': 'inline label - always visible', 'Suma_Capac': 'hidden field', 'Capacidad_': 'header label - always visible', 'Capacida_1': 'hidden field', 'Criterio q': 'hidden field', 'Cap Nom (k': 'hidden field', 'Coord. X': 'hidden field', 'Coord. Y': 'hidden field', 'Capacidad': 'inline label - always visible', });
